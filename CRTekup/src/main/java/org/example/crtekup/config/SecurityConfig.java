...
import org.example.crtekup.filter.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                                .requestMatchers("/auth/welcome", "/auth/register", "/auth/login","/api/videos/upload","auth/**").permitAll() // Public endpoints
                ...
                .addFilterBefore(authFilter, UsernamePasswordAuthenticationFilter.class); // JWT authentication filter
